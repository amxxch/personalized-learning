...
const CourseHeader = ({ course, currentChapter, progressPercent, assessmentDone } : CourseHeaderProps) => {
    ...
    const handlePerformanceAnalysis = () => {
        Navigate(`/course/${course?.courseId}/performance-analysis`, { replace: true });
    }
            ...
            <div className="bg-white shadow-lg rounded-2xl p-8">
                <div className="flex md:flex-row md:items-center md:justify-between gap-6">
                    <div className="flex-1">
                        ...
                        <div className="flex flex-col gap-24 mt-4 md:mt-0 md:ml-4 w-full md:w-64">
                        { assessmentDone ? 
                        ...
                        { assessmentDone && progressPercent > 0 &&
                        <button 
                            className="text-gray p-2 rounded-2xl font-semibold text-sm 
                            hover:underline flex justify-center items-center gap-2 text-center"
                            onClick={handlePerformanceAnalysis}
                        >
                            <BsFileBarGraph className='inline text-xl' />
